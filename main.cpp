...
int main(int argc, char *argv[])
{
	...
	else
	{
		...
		//The main loop
		//Every time of the loop the code draws a frame on the screen
		...
		while (!quit)
		{
			...
			//First compute a time step from the given bodies (integrator)
			//Then the bodies are rendered to the screen by rasterize function
